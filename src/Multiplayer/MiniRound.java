 ...
 * @author gmyrianthous
 */
public class MiniRound implements Runnable {
    ...
    /* Constructor */
    public MiniRound(int miniRoundID, int firstBidder, ArrayList<ConnectionNode> nodes, 
        ...
        try {            
          ...
          for (int j = 0; j < 4; j++){
            ...
            //recentlySelectedCard = nodes.get(bidderID).connectionInput.readUTF();
                        recentlySelectedCard = nodes.get(bidderID).getClientSelectedCard();
          ...
          Thread.sleep(6000);
            ...
            System.err.println("AIOOBE in miniround !!!!");
