 ...
 * @author gmyrianthous
 */
public class AIRound implements Runnable {
    
    private Team firstTeam;
    private AITeam secondTeam;
    ...
    public AIRound(AIGame game, Team firstTeam, AITeam secondTeam, int bidderID, int pointsA, int pointsB){
        this.game = game;
    ...
    public void run() {
        ...
        if (this.biddings.size() == 4 && (this.biddings.get(0).contains("Pass"))
            ...
            this.client.drawBidding(this.currentBid, this.currentSuit, this.currentTeamWinner);
            // Start 8 mini-rounds
            ...
            while (miniRoundID < 8){
                AIMiniRound newMini = new AIMiniRound(miniRoundID, miniRoundWinner, 
