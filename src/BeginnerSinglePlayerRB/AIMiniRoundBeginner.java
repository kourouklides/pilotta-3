 ...
 * @author gmyrianthous
 */
public class AIMiniRoundBeginner implements Runnable {
    ...
    /* Constructor */
    public AIMiniRoundBeginner(int id, int initialPlayerID, RealClient client, 
                       AIClientBeginner[] bots, String biddedSuit, String roundTeam) {
        this.id = id;
